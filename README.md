...
Copyright (C) 2000-2026 [std.prototype authors][authors]
...
Lua 5.1 (including LuaJIT), 5.2, 5.3, 5.4 and 5.5. The libraries are
copyright by their authors (see the [AUTHORS][] file for details), and
